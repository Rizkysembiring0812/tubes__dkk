                        ...
                        <div class="my-4">
                            <div class="row">
                                <div class="col-sm-6 col-md-3">
                                    <img src="{{ asset($question->product->productImage->first()->thumbnail) }}"
                                        class="img-fluid" alt="">
                                </div>
                                <div class="col-sm-12 col-md-9">
                                    <h4>{{ $question->product->title }}</h4>
                                    @if ($question->product->onSale)
                                        <p>Price : <span>Rp.{{ number_format($question->product->price) }}</span></p>
                                        <p>Sale Price : Rp.{{ number_format($question->product->sale_price) }} </p>
                                    @else
                                        <p>Price : Rp.{{ number_format($question->product->price) }} </p>
                                    @endif
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-8">
                                    <div class="form-group">
                                        ...
                                        <p class="text-gray-700">Asked by {{ $question->user->name }} on
