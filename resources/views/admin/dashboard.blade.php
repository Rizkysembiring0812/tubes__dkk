    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <button onclick="window.print()" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    class="fas fa-download fa-sm text-white-50"></i>Download Analisis Grafik</button>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="{{ route('userManagement.index') }}" style="text-decoration: none">
                    <div class="card border-left-info shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                ...
                <a href="{{ route('customerQuestion.adminView') }}" style="text-decoration: none">
                    <div class="card border-left-danger shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Feedback
                                    </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-center small">
                            ...
                            <span class="mr-2">
                                <i class="fas fa-circle text-info"></i> Aksesoris
                            </span>
                            <span class="mr-2">
                                <i class="fas fa-circle text-info"></i> Alat Tulis
                            </span>
                            <span class="mr-2">
                                <i class="fas fa-circle text-info"></i> Aplikasi Premium
                            </span>
                        </div>
                    </div>
                </div>
...
@push('js')
    <script>
        ...
        var myPieChart = new Chart(ctx, {
            type: 'doughnut',
            data: {
                labels: ["Makanan", "Minuman", "Aksesoris", "Alat Tulis", "Aplikasi Premium"],
                datasets: [{
                    data: [{{ $productCategory1 }}, {{ $productCategory2 }}, {{ $productCategory3 }},
                        {{ $productCategory4 }}, {{ $productCategory5 }}
                    ],
